...
void FeedbackState__rosidl_typesupport_introspection_c__FeedbackState_init_function(
...
void FeedbackState__rosidl_typesupport_introspection_c__FeedbackState_fini_function(void * message_memory)
{
  tm_msgs__msg__FeedbackState__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember FeedbackState__rosidl_typesupport_introspection_c__FeedbackState_message_member_array[40] = {
  {
    "header",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers FeedbackState__rosidl_typesupport_introspection_c__FeedbackState_message_members = {
  "tm_msgs__msg",  // message namespace
  "FeedbackState",  // message name
  40,  // number of fields
  sizeof(tm_msgs__msg__FeedbackState),
  FeedbackState__rosidl_typesupport_introspection_c__FeedbackState_message_member_array,  // message members
  FeedbackState__rosidl_typesupport_introspection_c__FeedbackState_init_function,  // function to initialize message memory (memory has to be allocated)
  FeedbackState__rosidl_typesupport_introspection_c__FeedbackState_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t FeedbackState__rosidl_typesupport_introspection_c__FeedbackState_message_type_support_handle = {
  0,
  &FeedbackState__rosidl_typesupport_introspection_c__FeedbackState_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tm_msgs, msg, FeedbackState)() {
  FeedbackState__rosidl_typesupport_introspection_c__FeedbackState_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
  if (!FeedbackState__rosidl_typesupport_introspection_c__FeedbackState_message_type_support_handle.typesupport_identifier) {
    FeedbackState__rosidl_typesupport_introspection_c__FeedbackState_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &FeedbackState__rosidl_typesupport_introspection_c__FeedbackState_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
