  ...
  tm_msgs__srv__AskItem_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tm_msgs__srv__AskItem_Request * data =
      (tm_msgs__srv__AskItem_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tm_msgs__srv__AskItem_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tm_msgs__srv__AskItem_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  tm_msgs__srv__AskItem_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    tm_msgs__srv__AskItem_Response * data =
      (tm_msgs__srv__AskItem_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tm_msgs__srv__AskItem_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          tm_msgs__srv__AskItem_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
